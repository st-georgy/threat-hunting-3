...
AnonMasons. У Вас есть данные сетевой активности в корпоративной сети
компании “СуперМегатек”. Данные хранятся в Yandex Object Storage.
...
1.  Поменяем права на файле с ssh-ключом, затем, используя его,
    выполняем вход на сервер по ssh.

![ssh](img/1.png)

1.  Меняем пароль у user14

![passwd](img/2.png)

1.  Заходим в RStudio Server под пользователем user14 по адресу
    127.0.0.1:8787

![login](img/3.png)

1.  Настраиваем через Personal Access Tokens доступ к Github
